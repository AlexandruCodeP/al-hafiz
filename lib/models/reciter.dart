...
class Reciter {
  ...
  /// Quran.com API recitation ID — used to fetch word-level timing segments.
  final int? quranComRecitationId;
  ...
  const Reciter({
    ...
    this.baseUrl,
    this.quranComRecitationId,
  });

  String get displayName => style != null ? '$name ($style)' : name;

  static const List<Reciter> all = [
    Reciter(id: 'alafasy', name: 'Mishary Rashid Alafasy', folder: 'Alafasy_128kbps', quranComRecitationId: 7),
    Reciter(id: 'abdulbasit_mujawwad', name: 'AbdulBaset AbdulSamad', folder: 'Abdul_Basit_Mujawwad_128kbps', style: 'Mujawwad', quranComRecitationId: 1),
    Reciter(id: 'abdulbasit_murattal', name: 'AbdulBaset AbdulSamad', folder: 'Abdul_Basit_Murattal_192kbps', style: 'Murattal', quranComRecitationId: 2),
    Reciter(id: 'sudais', name: 'Abdur-Rahman As-Sudais', folder: 'Abdurrahmaan_As-Sudais_192kbps', quranComRecitationId: 3),
    Reciter(id: 'shatri', name: 'Abu Bakr Ash-Shatri', folder: 'Abu_Bakr_Ash-Shaatree_128kbps', quranComRecitationId: 4),
    ...
    Reciter(id: 'hani_rifai', name: 'Hani Ar-Rifai', folder: 'Hani_Rifai_192kbps', quranComRecitationId: 5),
    Reciter(id: 'hudhaify', name: 'Ali Al-Hudhaify', folder: 'Hudhaify_128kbps'),
    Reciter(id: 'husary', name: 'Mahmoud Khalil Al-Husary', folder: 'Husary_128kbps', quranComRecitationId: 6),
    Reciter(id: 'husary_mujawwad', name: 'Mahmoud Khalil Al-Husary', folder: 'Husary_128kbps_Mujawwad', style: 'Mujawwad'),
    Reciter(id: 'husary_muallim', name: 'Mahmoud Khalil Al-Husary', folder: 'Husary_Muallim_128kbps', style: 'Muallim', quranComRecitationId: 12),
    ...
    Reciter(id: 'minshawy_mujawwad', name: 'Mohamed Siddiq Al-Minshawi', folder: 'Minshawy_Mujawwad_192kbps', style: 'Mujawwad', quranComRecitationId: 8),
    Reciter(id: 'minshawy_murattal', name: 'Mohamed Siddiq Al-Minshawi', folder: 'Minshawy_Murattal_128kbps', style: 'Murattal', quranComRecitationId: 9),
    Reciter(id: 'minshawy_teacher', name: 'Mohamed Siddiq Al-Minshawi', folder: 'Minshawy_Teacher_128kbps', style: 'Teacher'),
    Reciter(id: 'tablaway', name: 'Mohammad Al-Tablaway', folder: 'Mohammad_al_Tablaway_128kbps', quranComRecitationId: 11),
    ...
    Reciter(id: 'shuraym', name: "Sa'ud Ash-Shuraym", folder: 'Saood_ash-Shuraym_128kbps', quranComRecitationId: 10),
